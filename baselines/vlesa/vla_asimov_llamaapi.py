#!/usr/bin/env python3
"""
VLESA on ASIMOV benchmark — Llama API reasoning + fine-tuned Qwen3-VL safety filter.

Given egocentric video frames, the system infers the task goal, generates N candidate
next actions, scores each with the fine-tuned safety filter, and selects via constrained
decoding (task_score + alpha × safety_score).

Usage:
    python vla_asimov_llamaapi.py --frame-dirs-mode \
...
class VideoReasoningAgent:
    ...
    def __init__(
        ...
        self.client = LlamaAPIClient(api_key=config.api_key)
...
# python vla_asimov_llamaapi.py --frame-dirs-mode --base-frames-dir /path/to/data/vlesa/asimov_video/extracted_data --max-abs-error 3.0 --num-predictions 3

# CUDA_VISIBLE_DEVICES=1 python vla_asimov_llamaapi.py --frame-dirs-mode --base-frames-dir /path/to/data/vlesa/asimov_video/extracted_data --max-abs-error 3.0 --num-predictions 1

# CUDA_VISIBLE_DEVICES=2 python vla_asimov_llamaapi.py --frame-dirs-mode --base-frames-dir /path/to/data/vlesa/asimov_video/extracted_data --max-abs-error 3.0 --num-predictions 5

# CUDA_VISIBLE_DEVICES=3 python vla_asimov_llamaapi.py --frame-dirs-mode --base-frames-dir /path/to/data/vlesa/asimov_video/extracted_data --max-abs-error 3.0 --num-predictions 3 --vlm-model Llama-4-Maverick-17B-128E-Instruct-FP8
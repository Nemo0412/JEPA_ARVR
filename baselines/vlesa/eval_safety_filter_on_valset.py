#!/usr/bin/env python3
"""
Evaluate the prompt-based safety filter (Llama API) on the EgoSafety validation set.
...
from vla_asimov_baseline import SafetyQFilter, SafetyFilterConfig  # noqa: E402
...
if __name__ == "__main__":
    ...
    # python eval_safety_filter_on_valset.py --dataset-dir /path/to/egosafety_single_current_dataset --output-dir ./safety_filter_val_eval_llama4scout
#!/usr/bin/env python3
"""
VLESA on real egocentric video — Llama API reasoning + fine-tuned Qwen3-VL safety filter.

Variant of vla_offline_video.py that uses the Llama API for video reasoning instead
of OpenAI API, while keeping the local fine-tuned Qwen3-VL safety filter.

Usage:
    python vla_offline_video_llamaapi.py --frame-dirs-mode \
